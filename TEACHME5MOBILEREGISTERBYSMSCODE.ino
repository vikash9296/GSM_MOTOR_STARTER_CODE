/************************************************************************************
My Channel www.youttube.com/c/TeachMeSomething  // 

Thanks to Mr. Ahmad for Made this Wonderful Project....
 **********************************************************************************/

#include <SoftwareSerial.h>
#include <EEPROM.h>
//sender phone number with country code
//const String PHONE = "+919435601991";
const int totalPhoneNo = 5;
String phoneNo[totalPhoneNo] = {"","","","",""};
int offsetPhone[totalPhoneNo] = {0,10,20,30,40};
String tempPhone = "";
...
void parseData(String buff){
  ...
  if(buff != "OK"){
    ...
    if(cmd == "+CMTI"){
      ...
      //----------------------------------------------------------------------------
      if(msg.equals("r") && phoneNo[0].length() != 10) {
...
Serial.println("Date : "+ receivedDate);
